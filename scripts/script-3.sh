#!/bin/bash
# Stress Test Script - Group 3 (Heavy Load - 75% CPU)

set -e

echo "=========================================="
echo "Stress Test Group 3 - Heavy Load Setup"
echo "=========================================="
...
# Stress Test Configuration - Group 3
STRESS_LEVEL="heavy"
CPU_PERCENT=75
MEMORY_PERCENT=70
IO_WORKERS=4
...
echo "Starting Stress Test - Group 3 (Heavy Load)"
echo "==========================================="
...
[Unit]
Description=Stress Test Service - Group 3
...
echo "✅ Stress Test Group 3 setup complete!"
